...
public class Util
{
    ...
    //    {
    //        var ts = System.DateTime.Now - System.DateTime.Parse("1970-1-1");
    //        PlayerPrefs.SetString(key, ts.TotalSeconds.ToString());
    //    }

    //    public static void EndRecordTime(string key)
    //    {
    //        var ts = System.DateTime.Now - System.DateTime.Parse("1970-1-1");
    //        var nowT = ts.TotalSeconds;
    //        var startT = double.Parse(PlayerPrefs.GetString(key, "0"));
    //        GameLogger.Log(key + "耗时: " + (nowT - startT) + "秒");
    //    }
}